# Agile Team Project - *Codemasters Chess*

**Codemasters Chess** is a Ruby on Rails application that allows users to create a chess game and play against a friend.

Team Members: **Erik**

Time spent: **4** months

URL: **https://snapchat-erik.herokuapp.com/**  EXAMPLE
